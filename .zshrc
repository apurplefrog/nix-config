# If you come from b:qash you might have to change your $PATH.
...
nps() { nix search nixpkgs $1 }
alias prog="zellij --layout ~/.config/zellij/layouts/proglayout.kdl"
alias bore="zellij --layout ~/.config/zellij/layouts/boring.kdl"
alias parrotparty="zellij --layout ~/.config/zellij/layouts/parrotparty.kdl"
countdown() {
  clear
  for ((i = 10; i != 0; i--)); do
    echo "Shutdown in $i"
